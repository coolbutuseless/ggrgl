...
#' @export
#-----------------------------------------------------------------------------
scale_zend_continuous <- function(name = waiver(), breaks = waiver(), labels = waiver(),
                                          limits = NULL, range = c(1, 100),
                                          trans = "identity", guide = FALSE) {
  continuous_scale("zend", "zend", rescale_pal(range), name = name,
...
#' @usage NULL
#-----------------------------------------------------------------------------
scale_zend_ordinal <- function(..., range = c(1, 100)) {
  force(range)
